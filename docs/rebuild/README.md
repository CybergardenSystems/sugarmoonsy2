...
| Council-Reports | `COUNCIL_ROUND_{n}.md` | Runde(n) siehe Dateien |
| Final Report | [`FINAL_REPORT.md`](./FINAL_REPORT.md) | am Ende der Session |
| Historische QA-Runde (früherer Master-Prompt) | [`QA_PHASE5.md`](./QA_PHASE5.md) | archiviert |
