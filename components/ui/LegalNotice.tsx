      ...
      <div className="shell max-w-2xl">
        <div className="rounded-2xl border border-honey/15 bg-night-2/60 p-7">
          ...
          <p className="mt-4 text-[0.82rem] leading-relaxed text-moon-mute">
            Dieser Bereich ist als Platzhalter angelegt. Die verbindlichen Inhalte werden
            von Sugar Moon Sweets bereitgestellt und hier eingepflegt — rechtlich
            relevante Texte werden bewusst nicht generiert. Fragen?{" "}
            <a
