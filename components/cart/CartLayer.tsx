...
function QtyBtn({
  ...
  return (
    <button
      onClick={onClick}
      aria-label={label}
      className="flex h-10 w-10 items-center justify-center rounded-md border border-honey/15 text-moon transition-colors hover:border-honey hover:text-honey sm:h-9 sm:w-9"
    >
      {children}
    </button>
  );
